...
import { getAllEnabledIntegrations, deleteEnabledIntegrationByName } from '../action/application.actions';
import integrations_worning from "../../../image/integration-warning.svg";
import { Row, Col, Button, Select, Switch, Icon, message } from 'antd';
...
export class EnabledIntegrations extends Component {
  ...
  toggleDeleteModal = (name) => {
    if (name) {
      this.deleteEnabledIntegrationByName(name)
    }
    else {
  ...
  deleteEnabledIntegrationByName = (name) => {
    const { dispatch } = this.props;
    dispatch(deleteEnabledIntegrationByName(name))
      .then((res) => {
        if (res.error) {
            ...
            return <div className='table-box-container connection-table-box'>
              <div className="enabled-tab-box">
                ...
                <div className="enabled-tab-containt">
                  <Row>
                    <Col span={18}>
                      <div className="enabled-tab-heading">{res.applicationName}</div>
                ...
                {
                  res.applicationName == 'Kronos' && activeKey == res.key &&
                    ...
                    <form ref={node => this.fromNode = node} noValidate autoComplete="off" onSubmit={(e) => { this.handleSubmit(e) }}>
                      <div className="customer-info">
                        ...
                        <Row className="row">
                          ...
                          <div className='feild-desc'>The url of the Time and Attendance system that will be called to log worker punches</div>
                        </Row>
                            ...
                            <div className="del-box app-del">
                              <Row>
                                ...
                                <Col span={14} className="warrning-msg">
                                  <div>
                                    <div className="warnnig-text">Delete this Integration</div>
                ...
                <DeleteTenant
                  ...
                  modalName='Integrations'
                  typeName='oloid.com'
                  typeDetails={integrationDetials}
                  isRotate={false}
                />

                {
                  res.applicationName == 'Securits' && activeKey == res.key &&
                  <div className="collapse-form-padding">
                    {
                      activeKey == res.key &&
                      <div>
...
function mapStateToProps(state) {
  ...
  const { allEnabledIntegrations } = state.application;
  return {
    user,
