...
import { getAllIntegrations, instalPlugin } from '../action/application.actions';
        ...
        <Tabs onChange={this.onTabChange} activeKey={activeKey} defaultActiveKey="1">
          <TabPane tab="All Integrations" key="1">
            <Row>
              ...
              {
                allIntegrations.map((res, index) => {
                  return <Col key={index} span={12} className="integrations-tab-padding">
                    <div className="integrations-tab-main-box">
                      ...
                      <div className="integrations-tab-heading">{res.applicationName}</div>
